/* Holiday Mode for HivePress: settings screen behaviour.
 *
...
( function ( $ ) {
	...
	var CHROME = {
		...
		prefix: 'hphm',
		fieldPrefix: 'hp_holiday_mode_for_hivepress_',
	};
	...
	function chromeLabels() {
		return ( window.hphmBackendData && window.hphmBackendData.labels ) || {};
	}
